				   ...
				   tabPanel("Help",
				   		 sidebarLayout(
				   		 	sidebarPanel(
				   		 		...
				   		 		br(),
				   		 		p("Use the slider bars to adjust the exponents for the variables to include in the model."),
				   		 		br(),
				   		 		p("If you don't want a variable to be included just set its exponent value to zero."),
				   		 		br(),
				   		 	...
				   		 	mainPanel(
				   		 		...
				   		 		br(),
				   		 		h4('Model fitted:'), 
				   		 		p("This box contains the model fitted in the format:  mpg ~ I(var1^exp1) + I(var2^exp2) + ... etc."),
				   		 		br(),
				   		 		h4('Adjusted R-squared:'), 
				   		 		p("This box contains the value of the adjusted R-squared for your model, the closer you get to 1.0 the better you did!"),
				   		 		br(),
				   		 		h4('Diagnostic plots:'),
